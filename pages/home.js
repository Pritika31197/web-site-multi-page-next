    ...
    <>
      <HeaderComponent/>
        ...
        <div className='pera'>
          ...
          Today, small farms produce about a third of the world's food, but large farms are prevalent. The largest one percent of farms in the world are greater than 50 hectares and operate more than 70 percent of the world's farmland. Nearly 40 percent of agricultural land is found on farms larger than 1,000 hectares. However.

          </div>
          <div className='pera2'>
            <img src="Agri.jpg" height={500} width={700}/>
          </div>
        </div>
      <FooterComponent/>
      </>
